...
This document covers the full setup process for the portfolio backend infrastructure. Follow these steps in order to replicate the setup on a new machine or project.
