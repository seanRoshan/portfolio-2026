...
import { getJobDescription, getJobDescriptions, getResumes } from "@/lib/resume-builder/queries"
  ...
  return (
    <>
      ...
      <div className="p-4 md:p-6">
        <JDAnalyzerClient savedAnalyses={savedAnalyses} resumes={resumes} initialAnalysis={jd} />
      </div>
    </>
  )
}
