...
function ProjectCard({
  ...
  return (
    ...
    >
      <div className="glass hover:border-primary/20 hover:shadow-primary/5 overflow-hidden rounded-2xl transition-all duration-500 hover:shadow-2xl">
        {/* Image placeholder */}
        <div
  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="p-8">
          <h2 className="mb-2 text-[length:var(--text-3xl)] font-bold">{project.title}</h2>
