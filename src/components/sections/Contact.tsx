      ...
      <div className="container-wide">
        <div className="mx-auto max-w-2xl text-center">
          ...
          <TextReveal
            as="h2"
            type="words"
            className="mb-6 text-[length:var(--text-4xl)] leading-tight font-bold"
          >
          ...
          <RevealOnScroll delay={0.3}>
            <button
              onClick={copyEmail}
              className="glass group hover:border-primary/30 hover:shadow-primary/10 mb-12 inline-flex items-center gap-3 rounded-full px-6 py-3 transition-all duration-300 hover:shadow-lg"
            >
