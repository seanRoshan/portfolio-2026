        ...
        >
          {exps.map((exp) => (
            <div key={exp.id} style={{ marginBottom: "8px" }}>
              ...
              >
                <div>
                  <span style={{ fontWeight: 700, fontSize: density.heading, fontFamily: font }}>
                    {exp.job_title}
                  </span>
                  <span style={{ color: "#000", fontSize: density.heading, fontFamily: font }}>
                    {" "}
                    | {exp.company}
                  </span>
                </div>
              ...
              {exp.location && (
                <div style={{ fontSize: density.body, color: "#555", fontFamily: font }}>
                  {exp.location}
                </div>
              )}
            ...
            <div key={edu.id} style={{ marginBottom: "6px" }}>
              ...
              >
                <div>
                  ...
                  {edu.field_of_study && (
                    <span style={{ fontSize: density.heading, fontFamily: font }}>
                      {" "}
      ...
      resume.skill_categories.length > 0 ? (
        ...
        >
          {resume.skill_categories.map((cat) => (
            <div
              key={cat.id}
              style={{ marginBottom: "3px", fontSize: density.body, fontFamily: font }}
            >
        ...
        >
          ...
          {links.map((link, i) => (
            <span key={i}>
              ...
              <a
                href={link.url}
                style={{ color: accent, textDecoration: "none", fontFamily: font }}
              >
