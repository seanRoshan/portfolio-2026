        ...
        >
          {resume.education.map((edu) => (
            <div key={edu.id} style={{ marginBottom: "8px" }}>
              ...
              {edu.gpa && (
                <div style={{ fontSize: density.body, color: "#9ca3af" }}>GPA: {edu.gpa}</div>
              )}
              {edu.honors && (
                <div style={{ fontSize: density.body, color: "#9ca3af" }}>{edu.honors}</div>
              )}
            </div>
          ))}
        </Section>
  ...
  return (
    ...
    >
      ...
      <div style={{ marginBottom: density.sectionGap }}>
        <h1
          style={{ fontSize: `${nameSize}px`, fontWeight: 700, margin: 0, letterSpacing: "-0.5px" }}
        >
